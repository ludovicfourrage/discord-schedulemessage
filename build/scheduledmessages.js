...
exports.loadFromXLSX = exports.saveToExcel = void 0;
const xlsx = __importStar(require("xlsx"));
function saveToExcel(json2sheets, filename, overwritesheet, overwritefile) {
    let workbook;
...
function loadFromXLSX(filepath, sheet, options, loadOptions) {
...
exports.loadFromXLSX = loadFromXLSX;
